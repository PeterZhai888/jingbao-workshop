...
[{"shotNumber":1,"sceneDescription":"中景：人物站在书架前面对镜头，右手举起一本书，眉头微皱，语气认真","dialogue":"如果你每天都很努力，却还是赚不到钱……","duration":"3秒","cameraMove":"固定机位，手机与胸同高"}]`,
    ...
    // 🤖 AI视频（V2.2）：用户实测调优版——可生成性最高优先、风险降级（手部/多人/文字/背景元素）、反过度创作、第三人称默认视角；镜头数量规则保留共用插值（countRule）
...
同一连续场景中，相邻镜头应保持人物和主要物体的左右空间关系基本一致；无剧情需要时，不要突然改变人物左右位置或运动方向，避免空间方向混乱。
